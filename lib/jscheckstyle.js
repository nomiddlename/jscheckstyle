...
function cliTableRenderer(results) {
    ...
    results.forEach(function(file) {
        output.push("JSMeter results - ".green + file.filename);
        var table = new Table({
...
register(checkstyleRenderer, ['--checkstyle','CHECKSTYLE','checkstyle']);
register(jsonRenderer, ['--json','JSON','json']);
register(htmlRenderer, ['--html','TABLE','html']);
